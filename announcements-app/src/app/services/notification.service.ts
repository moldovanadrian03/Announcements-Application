...
export class NotificationService {
  ...
  initWebSocket(): void {
    ...
    this.connection.on('message_recieved', (body: any) => {
       //This code will be executed upon receiving a message with the name 'message_received'
       //from the server.
  ...
  sendMessage(methodName: string, parameters?: any[]): void {
